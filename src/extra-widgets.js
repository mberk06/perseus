...
module.exports = [
    __EDITOR__ = _widgetsCategorizerEditorJsx,
    __EDITOR__ = _widgetsCsProgramEditorJsx,
    __EDITOR__ = _widgetsDropdownEditorJsx,
    __EDITOR__ = _widgetsExplanationEditorJsx,
    __EDITOR__ = _widgetsDefinitionEditorJsx,
    __EDITOR__ = _widgetsGrapherEditorJsx,
    __EDITOR__ = _widgetsGradedGroupEditorJsx,
    __EDITOR__ = _widgetsGradedGroupSetEditorJsx,
    __EDITOR__ = _widgetsGroupEditorJsx,
    __EDITOR__ = _widgetsIframeEditorJsx,
    __EDITOR__ = _widgetsImageEditorJsx,
    __EDITOR__ = _widgetsInteractionEditorJsx,
    __EDITOR__ = _widgetsInteractiveGraphEditorJsx,
    __EDITOR__ = _widgetsLightsPuzzleEditorJsx,
    __EDITOR__ = _widgetsMatrixEditorJsx,
    __EDITOR__ = _widgetsMatcherEditorJsx,
    __EDITOR__ = _widgetsMeasurerEditorJsx,
    __EDITOR__ = _widgetsMoleculeEditorJsx,
    __EDITOR__ = _widgetsNumberLineEditorJsx,
    __EDITOR__ = _widgetsOrdererEditorJsx,
    __EDITOR__ = _widgetsPassageEditorJsx,
    __EDITOR__ = _widgetsPassageRefEditorJsx,
    __EDITOR__ = _widgetsPassageRefTargetEditorJsx,
    __EDITOR__ = _widgetsPlotterEditorJsx,
    __EDITOR__ = _widgetsReactionDiagramEditorJsx,
    __EDITOR__ = _widgetsSequenceEditorJsx,
    __EDITOR__ = _widgetsSimulatorEditorJsx,
    __EDITOR__ = _widgetsSorterEditorJsx,
    __EDITOR__ = _widgetsTableEditorJsx,
    __EDITOR__ = _widgetsTransformerEditorJsx,
    __EDITOR__ = _widgetsUnitEditorJsx,
    __EDITOR__ = _widgetsVideoEditorJsx,
